...
export const updateAdsQuota = (data, callback) => {
  return {
    type: types.UPDATE_ADS_QUOTA,
    payload: {
      data,
      callback,
    },
...
export const showModalUpdateAds = (data, callback) => {
  return {
...
export const hideModalUpdateAds = (data, callback) => {
  return {
