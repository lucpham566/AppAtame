...
function ModalUpdateBasePrice(props) {
  const currentShop = useSelector(store => store.account.currentShop);
  const {toggleModelUpdateBasePrice, adsId, updateBasePrice} = props;
  const {
    control,
    handleSubmit,
    formState: {errors},
  ...
  return (
    <Modal isVisible={true}>
      <View style={styles.container}>
        <Text style={styles.title}>Chỉnh sửa giá thầu</Text>
...
export default ModalUpdateBasePrice;
