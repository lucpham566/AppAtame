...
export const getProductAdsList = data => {
  return {
    type: types.KHAMPHA_GET_PRODUCT_ADS_LIST,
    payload: {
      data,
    },
  };
...
export const getProductAdsListDone = data => {
  return {
    type: types.KHAMPHA_GET_PRODUCT_ADS_LIST_DONE,
    payload: {
      data,
    },
  };
...
export const updateAdsPlacement = (data, callback) => {
  return {
    type: types.UPDATE_ADS_PLACEMENT,
    payload: {
      data,
      callback,
    },
...
export const updateAdsPlacementDone = data => {
  return {
    type: types.UPDATE_ADS_PLACEMENT_DONE,
    payload: {
      data,
    },
  };
